...
/* =========================================================================
   XSMN V2.6 — TRUE OOS PERFORMANCE MOBILE TEST
   Mobile UI Patch
   ========================================================================= */

function runOOSPerformanceV26Mobile(
  provinceSlug = 'kien-giang',
  giaiKey = 'db'
) {
  ...
  try {
    ...
    /*
     * Block 3 có thể dùng một trong các tên
     * evaluator dưới đây.
     * Tìm function đã tồn tại.
     */

    const candidates = [
      'evaluateOOSPerformanceV26',
      'evaluateOOSV26',
      'backtestOOSV26',
      'runOOSPerformanceV26'
    ];
    ...
    if (!fn) {
      ...
      alert(
        '⚠️ V2.6 PERFORMANCE\n\n' +
        'Block 3 đã load nhưng chưa tìm thấy ' +
        'hàm True OOS Performance.\n\n' +
        'Hãy gửi kết quả này cho mình.'
      );
    ...
    console.log(
      'V2.6 Mobile Performance function:',
      fnName
    );


    console.log(
      'V2.6 Mobile Performance result:',
      result
    );
    ...
    /*
     * Hiển thị JSON tạm thời.
     *
     * Mục đích của bước này là xác nhận
     * Block 3 chạy thật trên điện thoại.
     */
    ...
    /*
     * Tránh alert quá dài trên Android.
     */
    ...
    alert(
      '📊 XSMN V2.6 — TRUE OOS PERFORMANCE\n\n' +
      'Tỉnh: ' +
      provinceSlug +
      '\n' +
      'Giải: ' +
    ...
    console.error(
      'V2.6 OOS Performance Mobile:',
      error
    );


    alert(
      '❌ V2.6 PERFORMANCE ERROR\n\n' +
      String(
        error &&
        error.message
          ? error.message
...
function addOOSPerformanceButtonV26() {
  ...
  if (!settings) {
    ...
    console.warn(
      'V2.6 Performance UI: tab-settings not found'
    );
  ...
  button.textContent =
    '📊 Test V2.6 OOS Performance — Kiên Giang';
  ...
  console.log(
    'V2.6 OOS Performance Mobile button added'
  );
...
console.log(
  'XSMN V2.6 True OOS Performance Mobile UI ready'
);
